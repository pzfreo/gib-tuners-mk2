...
Usage:
    ...
    python scripts/visualize_single_housing.py --hand left
"""
...
def main() -> int:
    ...
    print(f"=== 1-Gang Assembly ({args.hand.upper()}) @ {args.scale}x ===")
